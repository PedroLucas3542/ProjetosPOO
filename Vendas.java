public class TestaProdutos {
	...
	public static void main(String args[]) {
		Livro livro = new Livro (1, 55.0, "Mapas Do Acaso: 123 Variações de um mesmo tema", "Humberto Gessinger", "010101001");
		...
		CompactDisc cd = new CompactDisc (2, 25.0, "De Fé", "Engenheiros do Hawaii", "MTV Brasil");
